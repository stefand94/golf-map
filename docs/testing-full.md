# Testing — full manual checklist

> This is the exhaustive Layer 2 checklist. The short version most changes
> need is `TESTING.md` in the repo root. Keep new interactive-feature steps
> here and summarise the load-bearing ones in `TESTING.md`.
> Note: some course counts below are stale (say 326 / "66 of 221"); the
> current totals are in `docs/project/PROJECT.md`.
