...
8a. **Marker clustering.** At any zoom wide enough to see more than one
   ...
   badge rather than rendering as 280 overlapping flags — badge color/size
...
10. **Trip Planning anchor search.** Open Trip Planning → By anchor
    ...
    280-option dropdown): typing a partial name (e.g. "Sunning") should
...
280-course static site with no backend.
