...
8a. **Marker clustering.** At any zoom wide enough to see more than one
   ...
   badge rather than rendering as 295 overlapping flags — badge color/size
...
10. **Trip Planning anchor search.** Open Trip Planning → By anchor
    ...
    295-option dropdown): typing a partial name (e.g. "Sunning") should
...
295-course static site with no backend.
